...
function showBlur() {
    $.post('https://aroma-inventory/showBlur');
}
...
function FormatAttachmentInfo(data) {
    $.post(
        "https://aroma-inventory/GetWeaponData",
        JSON.stringify({
            weapon: data.name,
...
function handleAttachmentDrag() {
    ...
    $(".weapon-attachments-remove").droppable({
        ...
        drop: function(event, ui) {
            $.post(
                "https://aroma-inventory/RemoveAttachment",
                JSON.stringify({
...
function handleDragDrop() {
    ...
    $("#item-drop").droppable({
        ...
        drop: function(event, ui) {
            ...
            $.post(
                "https://aroma-inventory/DropItem",
                JSON.stringify({
                    inventory: fromInventory,
                    item: fromData,
...
$(document).on("click", ".CombineItem", function(e) {
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post(
            "https://aroma-inventory/combineWithAnim",
            JSON.stringify({
        ...
        $.post(
            "https://aroma-inventory/combineItem",
            JSON.stringify({
...
function optionSwitch(
    ...
    $.post(
        "https://aroma-inventory/SetInventoryData",
        JSON.stringify({
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if (
            ...
            $.post("https://aroma-inventory/PlayDropSound", JSON.stringify({}));
            $.post(
                "https://aroma-inventory/SetInventoryData",
                JSON.stringify({
                    fromInventory: $fromInv.attr("data-inventory"),
            ...
            if (fromData.amount == $toAmount) {
                if (
                    ...
                    $.post(
                        "https://aroma-inventory/getCombineItem",
...
function InventoryError($elinv, $elslot) {
    ...
    $.post("https://aroma-inventory/PlayDropFail", JSON.stringify({}));
}
...
(() => {
    ...
    Inventory.Close = function() {
        ...
        $.post("https://aroma-inventory/CloseInventory", JSON.stringify({}));
...
$(document).on("click", "#rob-money", function(e) {
    ...
    $.post(
        "https://aroma-inventory/RobMoney",
        JSON.stringify({
            TargetId: TargetId,
        })
    );
...
$("#item-give").droppable({
    ...
    drop: function(event, ui) {
        ...
        $.post(
            "https://aroma-inventory/GiveItem",
            JSON.stringify({
                inventory: fromInventory,
                item: fromData,
                amount: parseInt(amount),
